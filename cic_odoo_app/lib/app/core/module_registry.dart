...
class ModuleRegistry {
  static const List<AppModule> all = [
    ...
    AppModule(key: 'recruitment', title: 'Reclutamiento', icon: Icons.person_search_rounded, color: Color(0xFF8E66FF), requiredPermission: 'recruitment.view', implemented: true),
    AppModule(key: 'reservas', title: 'Reservas', icon: Icons.calendar_month_rounded, color: Color(0xFF4F46E5), requiredPermission: null, description: 'Reserva servicios y recursos', implemented: true),
